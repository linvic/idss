            ...
            <div class="left handling">
              <router-link to="/initiateNew">
                <div class="handle_center">
                  <div class="el-icon-title">发起日报</div>
                  <i class="icon-edit"></i>
                </div>
              </router-link>
            </div>
          <div class="left handling">
              <div class="handle_center" @click="skipPersonWeekly()">
                <div class="el-icon-title">个人周报</div>
                <i class="icon-edit"></i>
              </div>
          </div>
          <div class="left handling">
              <div class="handle_center handle_center_noborder" @click="skipDepartWeekly()">
                <div class="el-icon-title">部门周报</div>
                <i class="icon-edit"></i>
              </div>
          </div>
          <div class="btn" @click="mindTask">
...
<script type="text/ecmascript-6">
  ...
  import {taskWeekly,taskDeptWeekly,getTaskType,departmentList,listAllUsers,listReportingUsers,getUsersObj,listByExecutor,impChangeOrdTask,getProjectList,publishTask,listTaskExecutors} from '../../service/getData'
