            ...
            <div class="user-title">
                ...
                <div class="" style="float:right;margin-right:47px;">
                    ...
                    <el-button
                        ...
                        type="primary"
                        plain
                        v-if="detailInfo.canCallBack"
                        @click.stop='callBackTask(detailInfo.id)'>撤回任务</el-button>
    ...
    methods: {
        ...
        editTask(id) {
            ...
            this.$nextTick(()=> {
                    ...
                    this.taskForm.projectId = this.detailInfo.projectId ? this.detailInfo.projectId : '';
                    this.taskForm.taskStatus = this.detailInfo.taskStatus; // 状态
                    this.taskForm.canDelete = this.detailInfo.canDelete; // 可否删除
