    ...
    <div class="wrapper">
        ...
        <el-dialog
            ...
            <el-form
                ...
                <el-form-item label="修改原因:" required v-if="(handTaskType == 2 && taskForm.taskStatus != 'TOSUBMIT') || (handTaskType == 3)" :class="{'is-change': handTaskType === 3 && (auditOldData.modifyReason != taskForm.modifyReason)}" prop="modifyReason">
