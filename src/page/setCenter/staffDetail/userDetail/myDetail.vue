...
<script type="text/ecmascript-6">
  // 注意标签和引入驼峰，可以有区别
  import { getUserTaskDetail,listByExecutor,getUserInfo,departmentList,listAllUsers,getStaffAssisTask,completeTask,editorUserInfo,getTaskType,impChangeOrdTask,getProjectList,publishTask,listTaskExecutors,listReportingUsers,changeTaskLevel,assessTask,getStaffTask,delayTaskCause,cancelTaskCause,perfmRpRecordAdd,getRewardList,userTaskReply,getRpAmountByType,getStaffNewRecordList,manageStaffWeekly } from 'service/getData'
      ...
      listAllUsers1() {
        listTaskExecutors().then((res) => {
          if(res.code == ERR_OK) {
           ...
           this.getUsersObj1(this.ruleForm11.value5)
           this._listByExecutor(this.ruleForm11.value5)
          }
       })
      },
