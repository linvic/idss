  ...
  <div class='task-manage'>
    <div class="wrapper">
      <div class="router-wrapper">
        ...
        <router-link to="/staffPersonWeekDetail">
      ...
      <div class="overHide">
        ...
        <el-table
          ...
          class="person"
          @row-click="openDetails"
          :data="tableDataPerson" style="width: 100%" empty-text='本周暂无个人重点任务'>
          <el-table-column
            label="序号"
            width="70"
          >
      ...
      <div class="overHide">
        ...
        <el-table
          ...
          @row-click="openDetails"
          class="commonPerson"
          :data="tableDataCommon" style="width: 100%" empty-text='本周暂无个人普通任务'>
          <el-table-column
            label="序号"
            width="70"
          >
      ...
      <div class="my-comment">
        ...
        <div class="comment-content">
          ...
          <div v-cloak v-if="!result.secondDeptHeaderComment" style="text-align: center;color: #5e7382;font-size: 14px">上级部门负责人评价暂时未对本周报作出评价</div>
        </div>
      </div>
      <div class="my-comment">
...
<script type="text/ecmascript-6">
  // 注意标签和引入驼峰，可以有区别
  import { getByStaffWeekly,userTaskReply,dragTask} from 'service/getData'
...
//      个人普通
    ...
    watch: {
      '$route' (to, from) {
        // 获取最新的id 调用获取数据方法
        if(to.query.id && to.path=="/staffPersonWeekDetail"){
          this.id = this.$route.query.id
          this.getData()
